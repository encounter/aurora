...
void GDSetVtxAttrFmtv(GXVtxFmt vtxfmt, const GXVtxAttrFmtList* list) {
    ...
    ASSERTMSGLINE(221, vtxfmt < GX_MAX_VTXFMT, "GDSetVtxAttrFmtv: invalid vtx fmt");

    for (; list->attr != GX_VA_NULL; ++list) {
        ASSERTMSGLINE(226, list->attr >= GX_VA_POS && list->attr <= GX_VA_TEX7, "GDSetVtxAttrFmtv: invalid attribute");
        ASSERTMSGLINE(227, list->frac < 32, "GDSetVtxAttrFmtv: invalid frac value");
...
void GDSetTexCoordGen(GXTexCoordID dst_coord, GXTexGenType func, GXTexGenSrc src_param, u8 normalize, u32 postmtx) {
    ...
    ASSERTMSGLINE(432, dst_coord < GX_MAX_TEXCOORD, "GDSetTexCoordGen: invalid texcoord ID");
    ...
    case GX_TG_TEXCOORD6:
        ...
        break;
    default:
        ASSERTMSGLINE(457, 0, "GDSetTexCoordGen: invalid texgen source");
        break;
    }
    ...
    case GX_TG_BUMP6:
    case GX_TG_BUMP7:
        ASSERTMSGLINE(481, src_param >= GX_TG_TEXCOORD0 && src_param <= GX_TG_TEXCOORD6, "GDSetTexCoordGen: invalid emboss source");
        tgType = 1;
    ...
    case GX_TG_SRTG:
        ...
        break;
    default:
        ASSERTMSGLINE(495, 0, "GDSetTexCoordGen: invalid texgen function");
        break;
    }
