...
if (CMAKE_SYSTEM_NAME STREQUAL iOS)
    target_sources(aurora_core PRIVATE lib/phone_haptics_ios.mm)
    set_source_files_properties(lib/phone_haptics_ios.mm PROPERTIES COMPILE_FLAGS -fobjc-arc)
    target_link_options(aurora_core PUBLIC "LINKER:-weak_framework,CoreHaptics")
else ()
    target_sources(aurora_core PRIVATE lib/phone_haptics.cpp)
endif ()
